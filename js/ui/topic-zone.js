...
const BTECH_SYLLABUS = {
  ...
  sections: {
    'Semester 1 — Foundation': [
      { icon: '📐', id: 'bt_maths1',     title: 'Mathematics – I (Calculus & Linear Algebra)',  desc: 'Indeterminate forms, sequences & series, matrices & linear algebra, differential calculus, integral calculus, vector calculus intro' },
      { icon: '⚗️', id: 'bt_physics',    title: 'Physics (Engineering Physics)',                desc: 'Wave optics, laser & fibre optics, quantum mechanics, solid state physics, semiconductor physics, electromagnetism' },
      { icon: '🧪', id: 'bt_chem',       title: 'Chemistry (Engineering Chemistry)',            desc: 'Water technology, corrosion & its control, electrochemistry, polymers & composites, fuels & lubricants, phase rule & alloys' },
      { icon: '🔌', id: 'bt_elec1',      title: 'Basic Electrical Engineering',                desc: 'DC circuits, AC fundamentals, single-phase AC circuits, three-phase AC circuits, transformers, electrical machines intro, electrical safety & earthing' },
      { icon: '🔧', id: 'bt_mechengg',   title: 'Basic Mechanical Engineering',                desc: 'Thermodynamic concepts, second law & entropy, IC engines, boilers & steam generators, power transmission elements, material science basics' },
      { icon: '✏️', id: 'bt_draw',       title: 'Engineering Graphics (Drawing)',              desc: 'Drawing instruments & lettering, geometric constructions, projections of points & lines, projections of planes & solids, sections, isometric & orthographic projections' },
      { icon: '🔨', id: 'bt_workshop1',  title: 'Workshop / Manufacturing Practices',         desc: 'Fitting shop, welding shop, carpentry shop, sheet metal shop, smithy shop, machine shop' },
    ],
    'Semester 2 — Engineering Fundamentals': [
      { icon: '📊', id: 'bt_maths2',     title: 'Mathematics – II (Differential Equations & Complex Analysis)', desc: 'Ordinary differential equations, higher-order linear ODE, Laplace transforms, Fourier series, partial differential equations, complex variables intro' },
      { icon: '⚙️', id: 'bt_mech',       title: 'Engineering Mechanics (Statics & Dynamics)',  desc: 'Force systems, equilibrium, friction, centroid & moment of inertia, kinematics, kinetics, virtual work' },
      { icon: '🖥️', id: 'bt_prog',       title: 'Programming in C / Computer Programming',    desc: 'Introduction to programming, C fundamentals, control structures, arrays & strings, functions, pointers, structures & unions, file handling' },
      { icon: '🌍', id: 'bt_envsc',      title: 'Environmental Science & Sustainability',     desc: 'Ecosystems, natural resources, biodiversity, environmental pollution, social issues, marine environment' },
      { icon: '📝', id: 'bt_commskills', title: 'Communication Skills / Professional English', desc: 'Fundamentals of communication, technical writing, grammar & vocabulary, presentation skills, group discussion & interview, comprehension & précis writing' },
      { icon: '⚓', id: 'bt_marine_intro',title: 'Introduction to Marine Engineering',         desc: 'History of shipping, ship terminology, marine engineering overview, ship classification societies, IMO, career in marine engineering, safety at sea' },
    ],
    'Semester 3 — Marine Core': [
      { icon: '📈', id: 'bt_maths3',     title: 'Mathematics – III (Numerical Methods & Statistics)', desc: 'Numerical solutions of algebraic equations, interpolation, numerical differentiation & integration, numerical solution of ODE, probability, probability distributions, statistics & regression' },
      { icon: '🌡️', id: 'bt_thermo2',    title: 'Thermodynamics & Heat Transfer',              desc: 'Thermodynamic systems & properties, first law applications, second law & availability, properties of pure substances, thermodynamic cycles, conduction, convection, radiation, heat exchangers' },
      { icon: '🔬', id: 'bt_strength',   title: 'Strength of Materials / Mechanics of Solids', desc: 'Simple stresses & strains, compound stresses, shear force & bending moment, bending stresses, shear stresses in beams, deflection of beams, torsion, columns & struts, thin & thick cylinders' },
      { icon: '💧', id: 'bt_fluid1',     title: 'Fluid Mechanics',                             desc: 'Fluid properties, fluid statics, fluid kinematics, fluid dynamics, viscous flow, boundary layer theory, dimensional analysis, flow through pipes' },
      { icon: '🔩', id: 'bt_materials',  title: 'Marine Materials & Metallurgy',               desc: 'Crystal structure & imperfections, phase diagrams, heat treatment, ferrous alloys, non-ferrous alloys, corrosion in marine environment, marine-grade materials, NDT, welding metallurgy' },
      { icon: '🧪', id: 'bt_sem3lab',    title: 'Thermo Lab + Fluid Mechanics Lab + Workshop', desc: 'Thermodynamics lab experiments, fluid mechanics lab (Bernoulli, Reynolds, metacentric height), pipe fitting, valve assembly, marine fitting practices' },
    ],
    'Semester 4 — Marine Systems': [
      { icon: '🔥', id: 'bt_boilers',    title: 'Marine Boilers & Steam Engineering',          desc: 'Steam generation, fire-tube boilers, water-tube boilers, boiler mountings & accessories, boiler water treatment, combustion, boiler operation & safety, maintenance, inert gas systems' },
      { icon: '🌡️', id: 'bt_thermo_app', title: 'Applied Thermodynamics (Power Engineering)',  desc: 'Steam nozzles, steam turbines, condensers, gas turbines, reciprocating air compressors, rotary compressors, refrigeration, psychrometry' },
      { icon: '⚡', id: 'bt_elec2',      title: 'Electrical Machines & Marine Electrotechnology', desc: 'DC generators, DC motors, transformers advanced, three-phase induction motors, synchronous machines, single-phase motors, marine electrical systems, electrical safety on ships' },
      { icon: '🔧', id: 'bt_manuf',      title: 'Manufacturing Processes & Marine Workshop Technology', desc: 'Casting, welding technology, metal forming, machining processes, CNC machining, fitting & piping, machine tools on ships' },
      { icon: '💧', id: 'bt_fluid2',     title: 'Fluid Machinery (Hydraulic Machines)',        desc: 'Impact of jets, hydraulic turbines, centrifugal pumps, reciprocating pumps, gear/vane/screw pumps, marine pumping systems, hydraulic systems' },
      { icon: '⚙️', id: 'bt_kinematics', title: 'Mechanics of Machines / Kinematics & Dynamics', desc: 'Mechanisms, velocity & acceleration analysis, cams, gears, governors, flywheel, balancing, vibrations' },
    ],
    'Semester 5 — Advanced Marine I': [
      { icon: '⚙️', id: 'bt_diesel1',    title: 'Marine Diesel Engines – I (Construction & Operation)', desc: 'Introduction to marine diesels, engine construction, running gear, fuel injection system, starting & reversing, scavenging & supercharging, engine timing, lubrication, cooling, modern engines' },
      { icon: '⚓', id: 'bt_naval1',     title: 'Naval Architecture – I (Ship Stability & Hydrostatics)', desc: 'Ship dimensions & form, displacement & tonnage, Simpson\'s rules, hydrostatic curves, transverse stability, GZ curves & large angle stability, trim, inclining experiment, intact stability criteria, damage stability' },
      { icon: '🔄', id: 'bt_aux',        title: 'Marine Auxiliary Machinery – I',               desc: 'Fuel oil systems, lubricating oil systems, fresh water generation, compressed air systems, steering gear, deck machinery, refrigeration & air conditioning, sewage treatment, oily water separator' },
      { icon: '📡', id: 'bt_electronics',title: 'Marine Electronics & Communication',          desc: 'Semiconductor devices, rectifiers & power supplies, amplifiers, digital electronics, sensors & transducers, communication systems, GMDSS, radar & ECDIS' },
      { icon: '🎛️', id: 'bt_control',    title: 'Marine Control Systems & Instrumentation',   desc: 'Control system fundamentals, control actions (P/PI/PD/PID), time response analysis, stability analysis, marine instrumentation, pneumatic & hydraulic control, automation (UMS), PLC & SCADA' },
      { icon: '✏️', id: 'bt_medraw',     title: 'Marine Engineering Drawing',                  desc: 'Drawing standards, engine component drawing, valve drawings, piping diagrams, boiler drawings, pump drawings, CAD introduction' },
    ],
    'Semester 6 — Advanced Marine II': [
      { icon: '⚙️', id: 'bt_diesel2',    title: 'Marine Diesel Engines – II (Performance & Maintenance)', desc: 'Engine performance parameters, indicator diagrams, combustion, turbocharger, engine governors, exhaust gas economizer, engine maintenance, engine troubleshooting, crankcase safety, emission control' },
      { icon: '⚓', id: 'bt_naval2',     title: 'Naval Architecture – II (Ship Construction)', desc: 'Ship structural members, framing systems, welded joints & connections, shell plating & decks, watertight subdivision, double bottom, fore & aft end construction, superstructure, ship types structural features, dry docking, ship surveys' },
      { icon: '🔧', id: 'bt_aux2',       title: 'Marine Auxiliary Machinery – II',              desc: 'Heat exchangers on ships, purifiers & clarifiers, marine governors & actuators, bow thrusters, propeller & shafting, stern tube & bearings, ship piping systems, incinerators, exhaust gas scrubbers' },
      { icon: '⚡', id: 'bt_elecpower',  title: 'Marine Electrical Power Systems',             desc: 'Ship electrical power plant, switchboard & distribution, generator paralleling, protection devices, motor control, emergency power, lighting systems, battery systems, high voltage on ships, electrical surveys & testing' },
      { icon: '🛡️', id: 'bt_safety',     title: 'Marine Safety & Fire Engineering',            desc: 'SOLAS convention, fire science, fire detection systems, fixed fire-fighting systems, portable fire-fighting equipment, structural fire protection, life-saving appliances, emergency procedures, ISM code & safety management' },
      { icon: '🔩', id: 'bt_machdesign', title: 'Machine Design for Marine Application',       desc: 'Design philosophy, design of shafts, design of keys & couplings, design of bolted joints, design of welded joints, spring design, bearing selection, gear design, design for marine components' },
    ],
    'Semester 7 — Management Level': [
      { icon: '🚢', id: 'bt_propulsion', title: 'Marine Propulsion Systems',                   desc: 'Ship resistance, propeller theory, propeller design, slow-speed diesel propulsion, medium-speed diesel propulsion, steam turbine propulsion, gas turbine propulsion, electric propulsion, alternative propulsion, shafting & transmission' },
      { icon: '🌍', id: 'bt_pollution',  title: 'Marine Pollution Prevention & Environmental Management', desc: 'MARPOL overview, Annex I–VI, ballast water management, anti-fouling systems, ship recycling' },
      { icon: '⚡', id: 'bt_advelec',    title: 'Advanced Marine Electrical Systems',          desc: 'Power electronics, rectifiers & inverters, DC-DC converters, VFD, shaft generators & motors, dynamic positioning, electric propulsion systems, condition monitoring' },
      { icon: '📜', id: 'bt_shipops',    title: 'Ship Operation & Management',                 desc: 'Maritime law basics, ISM code, ISPS code, MLC 2006, cargo operations, bunkering operations, planned maintenance system, maritime commercial operations, insurance & claims, dry dock management' },
      { icon: '🎓', id: 'bt_elective1',  title: 'Elective – I',                                desc: 'Option A: Computational Fluid Dynamics (CFD) for Marine Applications — OR — Option B: Marine Refrigeration & HVAC' },
      { icon: '📋', id: 'bt_project1',   title: 'Project – I / Seminar / Industrial Training', desc: 'Seminar, industrial training (4-6 weeks at shipyard/shipping company), project initiation' },
    ],
    'Semester 8 — Final Year': [
      { icon: '🚢', id: 'bt_ers',        title: 'Marine Engine Room Simulator (ERS)',           desc: 'Plant familiarization, main engine operation, auxiliary systems operation, generator operations, emergency scenarios, watch-keeping, bunkering simulation' },
      { icon: '📋', id: 'bt_competency', title: 'Marine Engineering Competency & Oral Preparation', desc: 'STCW convention, MEO Class IV syllabus review, oral examination preparation, practical assessments, documentation' },
      { icon: '🔬', id: 'bt_elective2',  title: 'Elective – II',                               desc: 'Option A: Vibration Analysis & Condition Monitoring — OR — Option B: Gas Carriers & Tanker Operations' },
      { icon: '🌱', id: 'bt_elective3',  title: 'Elective – III',                              desc: 'Option A: Renewable Energy & Green Shipping — OR — Option B: Offshore Engineering Fundamentals' },
      { icon: '🔬', id: 'bt_project',    title: 'Project – II (Major Project / Capstone)',      desc: 'Marine engine performance optimization, alternative fuels, emission reduction, propeller design, CFD analysis, automation, stability software development, energy efficiency' },
      { icon: '🎓', id: 'bt_grandviva',  title: 'Comprehensive Viva / Grand Viva',             desc: 'Marine diesel engines, naval architecture, marine auxiliary machinery, marine electrical, safety & environment, ship operations' },
    ],
  }
};
...
/* ── TOPIC_META for B.Tech topics (Ganpat University) ── */
Object.assign(TOPIC_META, {
  bt_maths1:     { diff:'Medium', time:45, paper:'Sem 1' },
  bt_physics:    { diff:'Medium', time:40, paper:'Sem 1' },
  bt_chem:       { diff:'Easy',   time:35, paper:'Sem 1' },
  bt_elec1:      { diff:'Medium', time:40, paper:'Sem 1' },
  bt_mechengg:   { diff:'Medium', time:40, paper:'Sem 1' },
  ...
  bt_envsc:      { diff:'Easy',   time:30, paper:'Sem 2' },
  bt_commskills: { diff:'Easy',   time:25, paper:'Sem 2' },
  bt_marine_intro:{ diff:'Easy',  time:30, paper:'Sem 2' },
  bt_maths3:     { diff:'Hard',   time:50, paper:'Sem 3' },
  bt_thermo2:    { diff:'Hard',   time:55, paper:'Sem 3' },
  bt_strength:   { diff:'Hard',   time:50, paper:'Sem 3' },
  bt_fluid1:     { diff:'Hard',   time:45, paper:'Sem 3' },
  bt_materials:  { diff:'Medium', time:35, paper:'Sem 3' },
  bt_sem3lab:    { diff:'Easy',   time:25, paper:'Sem 3 Practical' },
  bt_boilers:    { diff:'Hard',   time:55, paper:'Sem 4' },
  bt_thermo_app: { diff:'Hard',   time:55, paper:'Sem 4' },
  bt_elec2:      { diff:'Hard',   time:50, paper:'Sem 4' },
  bt_manuf:      { diff:'Medium', time:40, paper:'Sem 4' },
  bt_fluid2:     { diff:'Hard',   time:50, paper:'Sem 4' },
  bt_kinematics: { diff:'Hard',   time:50, paper:'Sem 4' },
  bt_diesel1:    { diff:'Hard',   time:60, paper:'Sem 5' },
  bt_naval1:     { diff:'Medium', time:40, paper:'Sem 5' },
  bt_aux:        { diff:'Medium', time:45, paper:'Sem 5' },
  bt_electronics:{ diff:'Hard',   time:50, paper:'Sem 5' },
  bt_control:    { diff:'Hard',   time:55, paper:'Sem 5' },
  bt_medraw:     { diff:'Easy',   time:30, paper:'Sem 5 Practical' },
  bt_diesel2:    { diff:'Hard',   time:60, paper:'Sem 6' },
  bt_naval2:     { diff:'Hard',   time:55, paper:'Sem 6' },
  bt_aux2:       { diff:'Medium', time:45, paper:'Sem 6' },
  bt_elecpower:  { diff:'Hard',   time:50, paper:'Sem 6' },
  bt_safety:     { diff:'Medium', time:40, paper:'Sem 6' },
  bt_machdesign: { diff:'Hard',   time:55, paper:'Sem 6' },
  bt_propulsion: { diff:'Hard',   time:55, paper:'Sem 7' },
  bt_pollution:  { diff:'Medium', time:45, paper:'Sem 7' },
  bt_advelec:    { diff:'Hard',   time:50, paper:'Sem 7' },
  bt_shipops:    { diff:'Medium', time:40, paper:'Sem 7' },
  bt_elective1:  { diff:'Medium', time:40, paper:'Sem 7 Elective' },
  bt_project1:   { diff:'Medium', time:30, paper:'Sem 7 Project' },
  bt_ers:        { diff:'Medium', time:40, paper:'Sem 8 Practical' },
  bt_competency: { diff:'Hard',   time:60, paper:'Sem 8' },
  bt_elective2:  { diff:'Medium', time:40, paper:'Sem 8 Elective' },
  bt_elective3:  { diff:'Medium', time:40, paper:'Sem 8 Elective' },
  bt_project:    { diff:'Hard',   time:120,paper:'Sem 8 Project' },
  bt_grandviva:  { diff:'Hard',   time:60, paper:'Sem 8 Viva' },
});
