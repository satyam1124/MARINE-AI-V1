...
function showProfileMenu() {
  ...
  menu.innerHTML =
    ...
    '<div style="border-top:1px solid var(--b0);padding-top:8px;display:flex;flex-direction:column;gap:4px;">' +
      ...
      (fbUser ?
        '<button onclick="fbLogout();localStorage.removeItem(\'miq_user_profile\');document.getElementById(\'profileMenu\').remove();const b=document.getElementById(\'profileBadge\');if(b)b.remove();showWelcomeModal();" style="padding:6px 10px;border-radius:6px;border:none;background:transparent;color:#ef4444;font-size:0.65rem;cursor:pointer;text-align:left;">🚪 Sign Out</button>' : 
        '<button onclick="localStorage.removeItem(\'miq_user_profile\');document.getElementById(\'profileMenu\').remove();const b=document.getElementById(\'profileBadge\');if(b)b.remove();showWelcomeModal();" style="padding:6px 10px;border-radius:6px;border:1px solid rgba(239,68,68,0.3);background:rgba(239,68,68,0.05);color:#ef4444;font-size:0.65rem;cursor:pointer;text-align:left;">🚪 Clear Profile & Sign Out</button>') +
