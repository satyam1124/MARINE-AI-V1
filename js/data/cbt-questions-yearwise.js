...
var CBT_QUESTIONS_YEARWISE = [
  ...
  // ── ENGLISH (NYK 2ND YEAR CBT SAMPLES) ──
  { id: 'y2e_nyk_01', question: 'Choose the correct word: "The vessel was _____ at the anchorage for 3 days."', options: ['stationed', 'parked', 'anchored', 'stopped'], correct: 2, explanation: 'Vessels are "anchored" at an anchorage.', category: 'English (CBT)', subject: 'english', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2e_nyk_02', question: 'Identify the error: "The crew was instructed to wore life jackets during the drill."', options: ['crew', 'instructed', 'wore', 'during'], correct: 2, explanation: '"wore" should be "wear" after the infinitive marker "to".', category: 'English (CBT)', subject: 'english', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2e_nyk_03', question: 'SMCP: What does "MAYDAY" signify?', options: ['Urgency', 'Safety', 'Distress', 'Warning'], correct: 2, explanation: 'Mayday signifies distress, indicating that a ship, aircraft, or vehicle is in grave and imminent danger and requires immediate assistance.', category: 'English (CBT)', subject: 'english', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2e_nyk_04', question: 'Choose synonym of "HAZARDOUS":', options: ['Safe', 'Dangerous', 'Clean', 'Easy'], correct: 1, explanation: 'Hazardous means risky or dangerous.', category: 'English (CBT)', subject: 'english', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2e_nyk_05', question: 'Fill in: "The ship _____ from Mumbai yesterday at 1400 hours."', options: ['has sailed', 'had sailed', 'sailed', 'will sailing'], correct: 2, explanation: 'Simple past tense is used for completed actions with a specific time in the past ("yesterday at 1400 hours").', category: 'English (CBT)', subject: 'english', yearLevel: 2, difficulty: 'intermediate' },

  // ── MATHEMATICS (NYK 2ND YEAR CBT SAMPLES) ──
  { id: 'y2m_nyk_01', question: 'A vessel travels 180 NM in 15 hours. What is its speed in knots?', options: ['10', '12', '15', '18'], correct: 1, explanation: 'Speed = Distance / Time = 180 / 15 = 12 knots.', category: 'Mathematics (CBT)', subject: 'maths', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2m_nyk_02', question: 'Pump A fills a tank in 6 hours. Pump B fills same tank in 4 hours. Working together, how long to fill the tank?', options: ['2 hrs', '2.4 hrs', '3 hrs', '5 hrs'], correct: 1, explanation: '1/6 + 1/4 = 5/12; Time = 12/5 = 2.4 hours.', category: 'Mathematics (CBT)', subject: 'maths', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2m_nyk_03', question: 'Convert 15 bar to PSI:', options: ['217.5 PSI', '150 PSI', '200 PSI', '225 PSI'], correct: 0, explanation: '1 bar ≈ 14.5 PSI; 15 × 14.5 = 217.5 PSI.', category: 'Mathematics (CBT)', subject: 'maths', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2m_nyk_04', question: 'HFO and MDO mixed in ratio 4:1. Total bunker = 500 MT. How much MDO?', options: ['400 MT', '125 MT', '100 MT', '80 MT'], correct: 2, explanation: 'MDO proportion = 1/(4+1) = 1/5. MDO = (1/5) × 500 = 100 MT.', category: 'Mathematics (CBT)', subject: 'maths', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2m_nyk_05', question: 'Area of a circular tank cover with diameter 1.4m:', options: ['1.54 m²', '4.4 m²', '6.16 m²', '0.77 m²'], correct: 0, explanation: 'Radius r = 0.7m. Area = πr² = 22/7 × 0.7 × 0.7 ≈ 3.14 × 0.49 = 1.54 m².', category: 'Mathematics (CBT)', subject: 'maths', yearLevel: 2, difficulty: 'intermediate' },

  // ── PHYSICS (NYK 2ND YEAR CBT SAMPLES) ──
  { id: 'y2p_nyk_01', question: 'Pressure at 15m depth in seawater (density 1025 kg/m³):', options: ['150.7 kPa', '100 kPa', '250 kPa', '50 kPa'], correct: 0, explanation: 'ρgh = 1025 × 9.81 × 15 = 150,828 Pa ≈ 150.8 kPa (closest is 150.7 for g=9.8).', category: 'Physics (CBT)', subject: 'physics', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2p_nyk_02', question: 'A gas at 2 bar is compressed to half its volume at constant temp. New pressure = ?', options: ['1 bar', '4 bar', '2 bar', '8 bar'], correct: 1, explanation: 'Boyle\'s Law: P1V1 = P2V2. 2 × V = P2 × 0.5V → P2 = 4 bar.', category: 'Physics (CBT)', subject: 'physics', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2p_nyk_03', question: 'Heat needed to raise 100 kg water from 20°C to 80°C: (Specific heat of water = 4.2 kJ/kg°C)', options: ['25,200 kJ', '12,600 kJ', '33,600 kJ', '42,000 kJ'], correct: 0, explanation: 'Q = mcΔT = 100 × 4.2 × 60 = 25,200 kJ.', category: 'Physics (CBT)', subject: 'physics', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2p_nyk_04', question: 'Three resistors 6Ω each connected in parallel. Total = ?', options: ['18Ω', '6Ω', '2Ω', '3Ω'], correct: 2, explanation: '1/R = 1/6 + 1/6 + 1/6 = 3/6; R = 2Ω.', category: 'Physics (CBT)', subject: 'physics', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2p_nyk_05', question: 'A 440V supply drives 10A current. Power consumed = ?', options: ['4.4 kW', '44 kW', '440 W', '4400 kW'], correct: 0, explanation: 'P = VI = 440 × 10 = 4400 W = 4.4 kW.', category: 'Physics (CBT)', subject: 'physics', yearLevel: 2, difficulty: 'intermediate' },

  // ── APTITUDE (NYK 2ND YEAR CBT SAMPLES) ──
  { id: 'y2a_nyk_01', question: 'Series: 3, 8, 15, 24, 35, ?', options: ['46', '48', '50', '52'], correct: 1, explanation: 'Differences between terms are 5, 7, 9, 11, 13. Next term = 35 + 13 = 48.', category: 'Aptitude (CBT)', subject: 'aptitude', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2a_nyk_02', question: 'If ANCHOR = 1,14,3,8,15,18 then STERN = ?', options: ['19,20,5,18,14', '20,19,5,18,14', '19,20,5,18,13', '19,20,5,17,14'], correct: 0, explanation: 'Letters correspond to their alphabetical order: S=19, T=20, E=5, R=18, N=14.', category: 'Aptitude (CBT)', subject: 'aptitude', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2a_nyk_03', question: 'Inlet valve fills tank in 8 hours. Outlet valve empties in 12 hours. Both open — time to fill = ?', options: ['20 hrs', '24 hrs', '10 hrs', '16 hrs'], correct: 1, explanation: 'Net filling rate = 1/8 - 1/12 = 3/24 - 2/24 = 1/24. 24 hours to fill the tank.', category: 'Aptitude (CBT)', subject: 'aptitude', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2a_nyk_04', question: 'Ship sails 5 NM North, 12 NM East. Distance from start = ?', options: ['17 NM', '13 NM', '7 NM', '15 NM'], correct: 1, explanation: 'Using Pythagoras: √(5² + 12²) = √(25 + 144) = √169 = 13 NM.', category: 'Aptitude (CBT)', subject: 'aptitude', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2a_nyk_05', question: 'Analogy: Rudder : Steering :: Propeller : ?', options: ['Navigation', 'Propulsion', 'Stability', 'Mooring'], correct: 1, explanation: 'Rudder provides steering; Propeller provides propulsion.', category: 'Aptitude (CBT)', subject: 'aptitude', yearLevel: 2, difficulty: 'intermediate' },

  // ── BASIC ELECTRICAL & ELECTRONICS (NYK 2ND YEAR CBT SAMPLES) ──
  { id: 'y2ee_nyk_01', question: 'In a ship\'s 440V, 3-phase system, the frequency is:', options: ['50 Hz', '60 Hz', '100 Hz', '25 Hz'], correct: 1, explanation: '60 Hz is standard for marine electrical systems to allow smaller motors for same RPM.', category: 'Electrical & Electronics (CBT)', subject: 'electrical', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2ee_nyk_02', question: 'A diode allows current to flow in:', options: ['Both directions', 'One direction only', 'No direction', 'Alternating directions'], correct: 1, explanation: 'A diode is a semiconductor component that allows electrical current to flow in one direction only (forward bias).', category: 'Electrical & Electronics (CBT)', subject: 'electrical', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2ee_nyk_03', question: 'Insulation resistance of a motor is measured using:', options: ['Ammeter', 'Voltmeter', 'Megger', 'Tachometer'], correct: 2, explanation: 'A Megohmmeter (Megger) applies a high voltage to test the integrity of insulation.', category: 'Electrical & Electronics (CBT)', subject: 'electrical', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2ee_nyk_04', question: 'In a step-down transformer:', options: ['Output voltage > Input voltage', 'Output voltage < Input voltage', 'Output voltage = Input voltage', 'No voltage at output'], correct: 1, explanation: 'A step-down transformer reduces voltage, so output voltage < input voltage.', category: 'Electrical & Electronics (CBT)', subject: 'electrical', yearLevel: 2, difficulty: 'intermediate' },
  { id: 'y2ee_nyk_05', question: 'The purpose of earthing on a ship is:', options: ['To increase voltage', 'To improve speed', 'To protect personnel from electric shock', 'To reduce fuel consumption'], correct: 2, explanation: 'Earthing (grounding) protects personnel by providing a safe path to ground for rogue electrical currents.', category: 'Electrical & Electronics (CBT)', subject: 'electrical', yearLevel: 2, difficulty: 'intermediate' },
