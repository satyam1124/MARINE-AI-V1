...
(function() {
  ...
  shell: {
    ...
    icon: '🐚', color: '#f59e0b', hq: 'London / The Hague', fleetSize: '2000+ daily vessels',
  ...
  torm: {
    ...
    icon: '🔷', color: '#0369a1', hq: 'Copenhagen, Denmark', fleetSize: '90+ product tankers',
  ...
  scorpio: {
    ...
    icon: '🦂', color: '#b91c1c', hq: 'Monaco', fleetSize: '90+ tankers',
  ...
  kline: {
    ...
    icon: '🇯🇵', color: '#dc2626', hq: 'Tokyo, Japan', fleetSize: '448 vessels',
  ...
  nyk: {
    ...
    icon: '🚢', color: '#1d4ed8', hq: 'Tokyo, Japan', fleetSize: '800+ vessels',
  ...
  mol: {
    ...
    icon: '🟠', color: '#ea580c', hq: 'Tokyo, Japan', fleetSize: '800+ vessels',
  ...
  andromeda: {
    ...
    icon: '🌟', color: '#6366f1', hq: 'Monaco / Mumbai', fleetSize: '30+ tankers & FSOs',
  ...
  eastaway: {
    ...
    icon: '📦', color: '#059669', hq: 'Singapore / Mumbai', fleetSize: '50+ container ships',
